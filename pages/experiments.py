...
def run_experiments(df_type, selected_data, selected_jail=None): 
    ...
    api_models.append('gpt-3.5-turbo')
    api_models.append('gemini-1.5-flash')
    api_models.append('claude-3-5-sonnet-20240620')
    st.write("Models:")
    st.write(models + api_models)
...
st.markdown("Here you can select only the models which runs through Ollama. \n")
